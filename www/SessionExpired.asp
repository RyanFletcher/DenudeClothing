...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/DenudeTemplate.dwt.asp" codeOutsideHTMLIsLocked="false" --><head>
 ...
 <title>Dènudè Clothing &gt; Session Expired</title>
   <link rel="icon" type="image/png" href="../Images/IndiCater.ico">
 <!-- InstanceEndEditable --> 
     ...
     <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
      <tr>
       <td colspan="6">
        ...
        <table>
        	<tr>
             <td align="center"><p id="title">Sorry, but it seems that your session has expired. </p>
               <p>If you had added any items to your basket then don't worry, because when you log back in, they will still be there. </p>
               <p>Please log back in to proceed with your order.</p>
             </tr>
        </table>   
        <!-- InstanceEndEditable -->
       </td>
