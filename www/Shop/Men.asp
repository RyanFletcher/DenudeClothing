  ...
  <td width="10">&nbsp;</td>
   <td width="100" height="100%" valign="top">
    ...
    <td> 
     ...
     <table cellpadding="15" cellspacing="0" border="0" width="930" align="center">
      <tr id="Menu" style="border-top:none;" align="center">
      	<td width="338" id="Menu" style="border-bottom: 1px solid #CCC;"><a id="selected" href="#">MEN</a></td>
        <td width="137" id="Menu" style="border-bottom: 1px solid #CCC;"><a href="Woman.asp">WOMEN</a></td>
	...
	Set InsertRecord = CreateObject("ADODB.Command")
		...
		InsertRecord.CommandText = "INSERT INTO Guests (FirstName) VALUES ('Guest')"
		InsertRecord.Execute
		InsertRecord.ActiveConnection.Close
	SourceVar = "SELECT TOP 1 GuestID FROM Guests ORDER BY GuestID DESC"
		Call OpenRecordSet(Guest,0,SourceVar)
			Session("GuestID") = Guest.Fields("GuestID")
		Guest.Close()		
	Else
	End If
	%>	
       <iframe frameborder="0" src="Men-iframe.asp" width="900" height="300"></iframe>
<!-- InstanceEndEditable -->
       </td>
      </tr>  
     </table>
