...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/DenudeTemplate.dwt.asp" codeOutsideHTMLIsLocked="false" --><head>
 ...
 <title>Dènudè > Accessories</title>
 <!-- InstanceEndEditable --> 
    ...
    <td> 
     ...
     <table cellpadding="15" cellspacing="0" border="0" width="930" align="center">
      <tr id="Menu" style="border-top:none;" align="center">
        ...
        <td width="365" id="Menu" style="border-bottom: 1px solid #CCC;"><a id="selected" href="Accessories.asp">ACCESSORIES</a></td>
       </tr>
     </table>
       <iframe frameborder="0" src="Accessories-iframe.asp" width="900" height="300"></iframe>
<!-- InstanceEndEditable -->
       </td>
      </tr>  
     </table>
