        ...
        <table border="0" width="100%" height="400">
         <tr>
          <td valign="top" width="51%">
           <div align="center">
          <table cellpadding="0" cellspacing="0" width="905" height="131">
         <tbody>
         <tr valign="top">
         <td width="326"><p id="title">User Accounts</p></td>
         </tr>
         <br />
         <br />
         <tr class="columnheader">
         <td height="30"><p><b>FIRST NAME</b></p></td><td width="124"><p><b>SURNAME</b></p></td><td width="453"><p><b>EMAIL ADDRESS</b></p></td>
         </tr>
         <%  SourceVar = "SELECT * FROM Users ORDER BY FirstName" 
				 Call OpenRecordSet(Users,0,SourceVar)
					 While NOT Users.EOF
					 UserIDVar = Users.Fields("UserID")
                    ...
                    <tr>                  
         <td height="30"><%= FirstNameVar %></td><td><%= SurnameVar %></td><td><%= EmailAddressVar %></td>
         <td>                  	 
         <form name="User<%= UserIDVar %>" method="post" action="Edit.asp">
<input type="submit" value="Edit User" /><input type="hidden" name="UserID" value="<%= UserIDVar %>"></form>
</td>
<td>
         <form name="User<%= UserIDVar %>" id="form" onsubmit="return Validatedelete(form);" method="post" action="Delete-Process.asp">
<input type="submit" value="Delete User" /><input type="hidden" name="UserID" value="<%= UserIDVar %>"></form>
</td>
         </tr>
         <tr>
         <td colspan="5"><hr width="100%" align="left" /></td>
         </tr>
...
<title>Dènudè > Management > Users</title>
