...
<% If Session("DenudeUser") = False then Response.Redirect("../Index.asp") End If %>
      ...
      <tr>
       <td colspan="6">
        ...
        <table cellpadding="15" cellspacing="0" border="0" width="930" align="center">
         <tr id="Menu" style="border-top:none;" align="center">      	   <td width="338" id="Menu" style="border-bottom: 1px solid #CCC;"><a href="index.asp">USERS</a></td>
           ...
           <td width="365" id="Menu" style="border-bottom: 1px solid #CCC;"><a href="../Items/index.asp">ITEMS</a></td>
</tr>
       </table>
                  <% UserIDVar = Request.Form("UserID")
				    SourceVar = "SELECT * FROM Users WHERE UserID =" & UserIDVar & "" 
				       Call OpenRecordSet(Users,0,SourceVar)
						 FirstNameVar = Users.Fields("FirstName")
						 SurnameVar = Users.Fields("Surname")
						 EmailAddressVar = Users.Fields("EmailAddress")
						 PasswordVar = Users.Fields("Password")
						 DenudeUserVar = Users.Fields("DenudeUser")
						 Users.Close()
				 %>
                 <br />
         <table align="center" width="654" height="65" cellpadding="0" cellspacing="0">
         <tr>
         <td width="160" align="center" style="border-right: 1px solid #CCC; border-left: 1px solid #CCC;"></td>
         <td width="314" align="center" style="border-right: 1px solid #CCC; border-left: 1px solid #CCC;"><h1><%= FirstNameVar & "'" & "s" %> Profile</h1></td>
         <td width="178" align="center" style="border-right: 1px solid #CCC; border-left: 1px solid #CCC;"></td>
         </tr>
         <br />
         <tr>
         <td style="border-right: 1px solid #CCC; border-left: 1px solid #CCC;" align="center"></td>
         	<td>
         <form onsubmit="return validateForm();" name="UserUpdate" method="post" action="Edit-Process.asp">
         <input placeholder="First Name" name="FirstName" type="text" value="<%= FirstNameVar %>"><br />
         <input placeholder="Surname" name="Surname" type="text" value="<%= SurnameVar %>"><br />
         <input placeholder="Email Address" name="EmailAddress" type="text" value="<%= EmailAddressVar %>"><br />
         <input placeholder="Password" type="password" name="Password" value=""><br />
         <input type="submit" value="Update User" />
         <input name="UserID" type="hidden" value="<%= UserIDVar %>" />
		</form>
        </td>
        <td style="border-right: 1px solid #CCC; border-left: 1px solid #CCC;" align="center"></td>
        </tr>
...
<title>Dènudè > Management > Users > Edit</title>
