     ...
     <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
      <tr>
       <td colspan="6">
         ...
         <tr>
         	<td>
                 <form onsubmit="return validateForm();" name="AddItem" method="post" action="Add-Process.asp">
         <input placeholder="Item Name" name="ItemName" type="text"><br />
         <input placeholder="Unit Price" name="UnitPrice" type="text"><br />
         <input placeholder="Image Source" name="ImageSource" type="text"><br />
