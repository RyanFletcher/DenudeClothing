       ...
       <td colspan="6">
        ...
        <table cellpadding="15" cellspacing="0" border="0" width="930" align="center">
         <tr id="Menu" style="border-top:none;" align="center">      	   <td width="338" id="Menu" style="border-bottom: 1px solid #CCC;"><a href="../Users/index.asp">USERS</a></td>
           ...
           <td width="365" id="Menu" style="border-bottom: 1px solid #CCC;"><a href="index.asp">ORDER STATUSES</a></td>
           <td width="365" id="Menu" style="border-bottom: 1px solid #CCC;"><a href="../Items/index.asp">ITEMS</a></td>
</tr>
       </table>
                  <% OrderStatusID = Request.QueryString("OrderStatusID")
				    SourceVar = "SELECT * FROM OrderStatuses WHERE OrderStatusID =" & OrderStatusID
				       Call OpenRecordSet(OrderStatus,0,SourceVar)
						 OrderStatusVar = OrderStatus.Fields("OrderStatus")
						 EmailAddressVar = OrderStatus.Fields("EmailAddressRedirection")
						 OrderStatus.Close()
				 %>
                 <br />
         ...
         <input placeholder="Order Status" name="OrderStatus" type="text" value="<%= OrderStatusVar %>"><br />
         ...
         <input name="OrderStatusID" type="hidden" value="<%= OrderStatusID %>" />
		</form>
        </td>
        </tr>
        </table>
