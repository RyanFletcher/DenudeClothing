       ...
       <table cellpadding="20" width="100%">
         <tr>
           <td width="43%" valign="middle">
             <p id="title">WELCOME TO DÉNUDÉ.</p>
             <br />
             <p>Unfortunately, our website is currently under construction. If you wish to be notified of the completion, please sign up to our mailing list.<br /><br /> 
             You may also receive some general information about promotion for Dènudè. Feel free to browse the website for further information  or email us at team@denudeclothing.com.</p>    
             <br />
             <p>Stay Nude.</p>
            </td>
            <td colspan="2" style="padding-right: 3px" width="57%">
           	 <% If len(Session("UserID")) = 0 Then %>
              <div align="right">
               <form name="SignUp" id="SignUp" method="post" onsubmit="return validateForm();" action="SignUp/SignUp-Email-Process.asp">
                <p id="title">SIGN UP FOR EMAILS<br /><br />
                 <% DuplicatedUserVar = Request.QueryString("DuplicatedUser")
				 	 If DuplicatedUserVar = 1 Then %>
