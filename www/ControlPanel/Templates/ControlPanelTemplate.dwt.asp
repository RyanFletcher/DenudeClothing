...
<!--#include file="../Functions/GlobalFunctions.asp" -->
...
<tr>
   <td colspan="2" height="102" align="center" valign="middle"><img width="300" height="100" src="../../Customisation/<%= Session("CompanyInfoID") %>/LogoV4.gif" /></td>
  </tr>
</table>  
     ...
     <tr>
      ...
      <td valign="top" height="40%"width="60%">
       <div id="ContentHolder">
        <table>
         <tr>
         <td width="519" height="48" valign="top">Headlines:<% 'Call GetHeadlines(CompanyInfoID,AuthenticationID) %></td>
         </tr>
         <tr>
