     ...
     <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
      <tr>
       <td colspan="6">
        ...
        <table cellpadding="5" border="0" width="100%" height="280">
         <tr>
<td width="25%"></td>
         <td width="50%" align="center" style="border-right: 1px solid #CCC; border-left: 1px solid #CCC;"><p id="title">Contact Us</p></td>
         <td width="25%"></td>          </tr>
          <tr>
<td></td>
          <td valign="top" align="center" style="border-right: 1px solid #CCC; border-left: 1px solid #CCC;" width="50%">
          <p>If you wish to contact us, you can either email us directly at team@denudeclothing.com or you can simply fill out the form below and we will get back to you as soon as possible.</p>
          </td>
<td></td>
          </tr>
          <tr>
<td></td>
          <td align="center" style="border-right: 1px solid #CCC; border-left: 1px solid #CCC;">
          <form name="contact" action="" method="post">
          <input type="text" placeholder="First Name" id="firstname" /><br />
          <input type="text" placeholder="Surname" id="surname" /><br />
          <input type="text" placeholder="Email Address" id="EmailAddress" /><br />
          <textarea wrap="virtual" cols=""  placeholder="Let us know what you think or ask us a question?" rows="100"></textarea><br  />
