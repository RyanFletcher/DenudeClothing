        ...
        <table border="0" width="100%" height="400">
          <tr>
            <td align="center" width="49%">
              ...
              <p>&nbsp;</p>
              <p>Thanks for signing up to Denude. <br />Please be aware the the use of cookies has been activated during your stay at www.denudeclothing.com. <br />
                If you wish to review the relevant information aout Cookies, please click<a href="../Cookies/Index.asp">here.</a> <br />
                If you require any further information about the Company, please do not hesitate to contact us via email: support@denudeclothing.com. <br />
                For copyright & legal notices, please click<a href="Legal.asp">here</a></p>
              <p>&nbsp;</p>
              <% If ItemIDVar > 0 Then %>
              <form action="../Shop/Checkout/Basket.asp">
              <input type="submit" value="Click here to proceed to your basket" />
              </form>
              <% Else %>
              <form action="../Shop/Men.asp">
