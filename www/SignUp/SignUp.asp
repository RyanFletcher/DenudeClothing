...
<table cellpadding="50" width="100%" height="100%" align="center">
 <tr valign="top">
  <td width="10">&nbsp;</td>
     ...
     <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
      <tr>
       <td colspan="6">
        ...
        <div id="tabContent">
        <table cellpadding="20" border="0" width="100%" height="350">
         <tr>
          <td style="border-right: 1px solid #000000;" valign="middle" align="left" id="title" width="320"><p id="title">Sign In<br /><br /></p>
            <form class="FormLabel" name="Login" id="Login" method="post" action="../../Login/Authenticate.asp">
                <% If WrongEmailVar > 0 Then %>
        <p id="FormLabel"> Incorrect Email Address </p>
        	<% Else 
				End If %>
       <% If IncorrectPasswordVar > 0 Then %>
       </p> <p id="FormLabel"> Incorrect Password </p><p id="FormLabel">
        	<% Else 
				End If %>
             <input placeholder="Email Address" name="EmailAddress" width="10" type="text" /> <input width="10" placeholder="Password" name="Password" type="password" /><br />
         <input type="submit" value="Log In" class="Button"> 
        </form></p>
        </td>
		<td align="center" valign="top" style="border-right: 1px solid #000000;" width="132">
        <a href="#" onclick="return toggle_visibility('Guest');"><p>Login as a guest</p></a>
        <div style="display:none;" id="Guest">
        <form name="Guest" action="../SignUp/SignUp-Guest.asp?ItemID=<%= ItemIDVar %>&amp;Addition=1" method="post">
               <input onkeypress="return textonly(event);" placeholder="First Name" id="FirstName" name="FirstName" type="text" /><br />
               <input onkeypress="return textonly(event);" placeholder="Surname" id="Surname" name="Surname" type="text" /><br />
               <input placeholder="Address" id="Address" name="Address" height="100" type="text" /><br />
               <input placeholder="Email Address" id="EmailAddress" name="EmailAddress" type="text" /><br />
          ...
          <td align="right" width="350">
           <div>
           <form onsubmit="return validateForm();" name="SignUp" id="SignUp" method="post" action="SignUp-Process.asp">
             <p id="title">Sign up<br /><br /></p>
             <p>
               <input onkeypress="return textonly(event);" placeholder="First Name" id="FirstName" name="FirstName" type="text" /><br />
              <input  onkeypress="return textonly(event);" placeholder="Surname" id="Surname" name="Surname" type="text" /><br />
              ...
              <% 
			  'If the user has added an item to a basket but does not have an account then pass the ItemID
			  If ItemIDVar > 0 Then %>
               <input name="ItemID" id="ItemID" type="hidden" value="<%= ItemIDVar %>" />
               <% Else
			   		End If %>
   ...
   <script src="../JavaScript/ToggleVisibility.js" language="javascript"></script>
  <!-- InstanceEndEditable -->
       </td>
      </tr>  
     </table>
